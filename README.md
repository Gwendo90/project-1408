...
reactions/              12 Katzen als PNG, 320×320, mit gebackenem Aufkleberrand
...
Ein Knopf unten rechts, aufgefaltet erscheinen zwölf Katzen (`reactions/`), eine Auswahl fliegt
...
* **Die Ringzahl wird gerechnet, nicht festgelegt.** `katzenRinge(n)` sucht das kleinste k, bei
  ...
  Knopfdurchmesser samt Luft übertrifft. Mit acht Katzen reichten zwei Ringe, mit zwölf und mit
  vierzehn sind es drei. Fest verdrahtet hätten spätere Zugänge die alten überlappt.

  Die Obergrenze der Schleife lag ursprünglich bei vier Ringen — und gab bei zwischenzeitlich 25
  Katzen **trotzdem vier zurück**, obwohl vier nicht reichten. Die Kacheln überlappten sich dann
  um 10px, ohne dass irgendwo etwas gemeldet hätte. Sie steht jetzt bei sechs, auch wenn zwölf
  Katzen weit darunter liegen: Sie kostet nichts und fängt den Fall beim nächsten Mal ab.
  ...
  gemessen). Mehr Katzen heißt also: mehr Ringe, nicht mehr Grad. Die Knöpfe sind von 42 auf
  **36px** geschrumpft, sonst reichte der dritte Ring über den rechten Rand. Nachgemessen auf
  320×568, 375×667, 390×844 und 430×932: keine Überlappung, keine Katze außerhalb.
